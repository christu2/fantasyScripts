...
def post_season_preview_to_discord(division_embeds: list, season: int = 2026):
    """Posts the multi-embed Annual Season Preview to #commissioner-desk."""
    ...
    if success:
        print("🚀 Successfully broadcasted Annual Season Preview to #commissioner-desk!")
...
def main():
    ...
    if args.discord:
        post_season_preview_to_discord(division_embeds, args.season)
