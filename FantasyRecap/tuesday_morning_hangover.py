...
def build_hangover_dialogue(season: int = 2025, week_num: int = 1) -> list:
    ...
    d.append(('CHRIS', "Now let's head down to the media room for our post-game press conference soundbites collected after midnight. Sydney was asked about taking down Luke-ose and said: 'Dropping a thirty-point beatdown on the four-time champ in week one sets the standard. We are here to win the whole damn thing!'"))
    ...
    d.append(('DAVE', "Get your waiver bids in tonight, bench the bums who gave you zero points, and for the love of God, don't leave thirty points on your pine like Luke-ose! For Chris, Dave, and the entire BFL Tuesday Morning Hangover crew, have a great Tuesday everybody!"))
